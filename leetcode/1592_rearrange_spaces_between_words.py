...
if __name__ == '__main__':
    ...
    assert 'this   is   a   sentence' == solution.reorderSpaces('  this   is  a sentence ')
    assert 'practice   makes   perfect ' == solution.reorderSpaces(' practice   makes   perfect')
    assert 'hello   world' == solution.reorderSpaces('hello   world')
    assert 'walks  udp  package  into  bar  a ' == solution.reorderSpaces('  walks  udp package   into  bar a')
