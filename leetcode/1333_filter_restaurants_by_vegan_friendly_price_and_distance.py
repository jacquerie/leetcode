        ...
        return [
            ...
            for restaurant in sorted(
                (
                    ...
                    if (
                        (restaurant.veganFriendly == 1 if veganFriendly == 1 else True)
                        and restaurant.price <= maxPrice
                        and restaurant.distance <= maxDistance
                    )
                ),
...
if __name__ == "__main__":
    ...
    assert [3, 1, 5] == solution.filterRestaurants(
        [
            [1, 4, 1, 40, 10],
            [2, 8, 0, 50, 5],
            [3, 8, 1, 30, 4],
    ...
    assert [4, 3, 2, 1, 5] == solution.filterRestaurants(
        [
            [1, 4, 1, 40, 10],
            [2, 8, 0, 50, 5],
            [3, 8, 1, 30, 4],
    ...
    assert [4, 5] == solution.filterRestaurants(
        [
            [1, 4, 1, 40, 10],
            [2, 8, 0, 50, 5],
            [3, 8, 1, 30, 4],
